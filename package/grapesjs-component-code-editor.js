            ...
            var i = n(0),
                ...
                E = function (e, t) {
                    ...
                    var p = v(c[0]).parentNode,
                        ...
                        _ = m(t, "cursor", "horizontal" === L ? "col-resize" : "row-resize"),
                        T = m(t, "gutter", y),
                    ...
                    function W(e) {
                        ...
                        this.dragging &&
                            ...
                            n <= i.minSize + x + this._b ? (n = i.minSize + this._b) : n >= this.size - (r.minSize + x + this._c) && (n = this.size - (r.minSize + this._c)),
                            A.call(this, n),
                            m(t, "onDrag", h)(R()));
                    }
                    function U() {
                        ...
                        (this.size = i[n] + o[n] + this._b + this._c), (this.start = i[r]), (this.end = i[s]);
                    }
                    function $(e) {
                        var t = (function (e) {
                            ...
                            if (!t) return null;
                            var n = e[o];
                            return 0 === n ? null : (n -= "horizontal" === L ? parseFloat(t.paddingLeft) + parseFloat(t.paddingRight) : parseFloat(t.paddingTop) + parseFloat(t.paddingBottom));
                        })(p);
                        if (null === t) return e;
                        if (
                        ...
                        var n = 0,
                            ...
                            r = e.map(function (r, s) {
                                var o = (t * r) / 100,
                                    ...
                                    c = O[s] + a;
                                return o < c ? ((n += c - o), i.push(0), c) : (i.push(o - c), o);
                            });
                        return 0 === n
                            ? e
                            : r.map(function (e, r) {
                    ...
                    "horizontal" === L ? ((n = "width"), (i = "clientX"), (r = "left"), (s = "right"), (o = "clientWidth")) : "vertical" === L && ((n = "height"), (i = "clientY"), (r = "top"), (s = "bottom"), (o = "clientHeight")),
                        (S = $(S));
                    var F = [];
                    function N(e) {
                        var t = e.i === F.length,
                    ...
                    return (
                        (a = c.map(function (e, t) {
                            ...
                            if (t > 0 && (((i = { a: t - 1, b: t, dragging: !1, direction: L, parent: p })._b = g(P, t - 1 == 0, !1, j)), (i._c = g(P, !1, t === c.length - 1, j)), "row-reverse" === E || "column-reverse" === E)) {
                                var s = i.a;
                                (i.a = i.b), (i.b = s);
                            }
                            if (t > 0) {
                            ...
                            return M(r.element, r.size, g(P, 0 === t, t === c.length - 1, j), t), t > 0 && F.push(i), r;
                        })).forEach(function (e) {
                                ...
                                t.forEach(function (e, n) {
                                    if (n > 0) {
                                        var i = F[n - 1],
                                            r = a[i.a],
                                            s = a[i.b];
                                        (r.size = t[n - 1]), (s.size = e), M(r.element, r.size, i._b, r.i), M(s.element, s.size, i._c, s.i);
                                    }
                                });
                            },
                            getSizes: R,
                                ...
                                F.forEach(function (i) {
                                    if ((!0 !== t ? i.parent.removeChild(i.gutter) : (i.gutter.removeEventListener("mousedown", i._a), i.gutter.removeEventListener("touchstart", i._a)), !0 !== e)) {
                                        ...
                                        Object.keys(r).forEach(function (e) {
                                            (a[i.a].element.style[e] = ""), (a[i.b].element.style[e] = "");
                                        });
                                    }
                                });
                            },
            ...
            var w = (function () {
                    function e(t, n) {
                        o()(this, e),
                            ...
                            (this.panelViews = n.appendTo ? this.$(n.appendTo) : this.findWithinEditor(".".concat(this.pfx, "pn-").concat(n.panelId))),
                            (this.isShowing = !0);
                    }
                    return (
                        c()(e, [
                                ...
                                value: function (e) {
                                    ...
                                    return t.CodeManager.createViewer(
                                        (function (e) {
                                            ...
                                            return e;
                                        })({ codeName: "html" === e ? "htmlmixed" : "css", theme: "hopscotch", readOnly: 0, autoBeautify: 1, autoCloseTags: 1, autoCloseBrackets: 1, styleActiveLine: 1, smartIndent: 1 }, n.codeViewOptions)
                                    );
                                },
                            },
                            {
                                ...
                                value: function (e, t) {
                                    var n = this.$,
                                        ...
                                        a = r.cleanCssBtn && "css" === e ? '<button class="cp-delete-'.concat(e, " ").concat(i, 'btn-prim">').concat(r.cleanCssBtnText, "</button>") : "";
                                    s.append(
                                        n(
                                    ...
                                    var c = t.getElement();
                                    return (c.style.height = "calc(100% - 30px)"), s.append(c), this.codePanel.append(s), s.get(0);
                                },
                            },
                            {
                                key: "buildCodePanel",
                                value: function () {
                                    ...
                                    i && !this.opts.appendTo && i.set("appendContent", this.codePanel).trigger("change:appendContent"),
                                        ...
                                        E(r, { direction: "vertical", sizes: [50, 50], minSize: 100, gutterSize: 1, onDragEnd: this.refreshEditors.bind(this) }),
                                        n.on("component:update", function (t) {
                                            return e.updateEditorContents();
                                        }),
                                        n.on("stop:preview", function () {
                                            e.isShowing && !e.opts.preserveWidth && e.canvas.css("width", e.opts.openState.cv);
                                        });
                                },
                            },
                            {
                                ...
                                value: function () {
                                    (this.isShowing = !0),
                                        ...
                                        this.opts.preserveWidth || (this.panelViews.css("width", this.opts.openState.pn), this.canvas.css("width", this.opts.openState.cv));
                                },
                            },
                            {
                                key: "hideCodePanel",
                                value: function () {
                                    this.codePanel && this.codePanel.css("display", "none"),
                                        (this.isShowing = !1),
                                        this.opts.preserveWidth || (this.panelViews.css("width", this.opts.closedState.pn), this.canvas.css("width", this.opts.closedState.cv));
                                },
                            },
                            {
                                key: "refreshEditors",
                                ...
                                value: function (e) {
                                    ...
                                    if (i && i !== this.previousHtmlCode) {
                                        ...
                                        this.cssCodeEditor
                                            ...
                                            "wrapper" === n.attributes.type ? t.setComponents(i) : t.select(n.replaceWith(i));
                                    }
                                },
                            },
                            {
                                ...
                                value: function (e) {
                                    ...
                                    t && t !== this.previousCssCode && ((this.previousCssCode = t), this.editor.Css.addRules(t));
                                },
                            },
                            {
                                ...
                                value: function (e) {
                                    var t = this;
                                    null == e || e.preventDefault(),
                                        this.cssCodeEditor.editor.getSelections().forEach(function (e) {
                                ...
                                value: function (e) {
                                    ...
                                    return e.map(function (e) {
                                        var r = i.get(e.selectors),
                                            ...
                                            a = t.atRuleType,
                                            c = t.atRuleParams;
                                        return r && n.Css.get(r, s, c, { selectorsAdd: o, atRule: a });
                                    });
                                },
                            },
                            {
                                ...
                                value: function () {
                                    this.isShowing &&
                                        ...
                                        this.component &&
                                            (this.htmlCodeEditor.setContent(this.getComponentHtml(this.component)), this.cssCodeEditor.setContent(this.editor.CodeManager.getCode(this.component, "css", { cssc: this.editor.Css }))));
                                },
                            },
                            {
                                ...
                                value: function (e) {
                                    ...
                                    var s = n.clearData ? e.toHTML() : "wrapper" === e.attributes.type ? r.innerHTML : r.outerHTML;
                                    !n.clearData && r.classList.add("".concat(t, "selected")), (i += s);
